...
public class _2CtoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._2activity_sto );
        ...
        buttonFuel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent opnRefuel=new Intent(_2CtoActivity.this,_3RefuelingActivity.class);
        ...
        buttonRepairs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent opnRepairs=new Intent(_2CtoActivity.this,_4RepairsActivity.class);
        ...
        buttonOil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent opnOil=new Intent(_2CtoActivity.this,_5OilActivity.class);
        ...
        buttonNotes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent opnNotes=new Intent(_2CtoActivity.this,_6NotesActivity.class);
        ...
        buttonMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent opnMenu=new Intent(_2CtoActivity.this,_1HomeActivity.class);
